...
// export default function ScanCardScreen() {
//   const { cartTotal, findStudentByCard, recordTxn, CURRENCY, cart } =
//     useStore();
//   const [cardId, setCardId] = useState("");
//   const [student, setStudent] = useState(null);
//   const [isKeyboardVisible, setIsKeyboardVisible] = useState(false);
...
//     // API call to charge the card on the server
//     try {
...
//             barcodeValue: id,
//             amount: cartTotal,
//             note: "POS purchase", // Or a more detailed note
//           }),
//         }
//       );
...
//       // If the API call is successful, record the transaction locally
//       await recordTxn({
//         student_id: id,
//         student_name: name,
//         items: cart,
...
//         // The outstanding balance is now handled by the API, so we can't
//         // accurately calculate it locally. We can default to 0.
//         outstanding_after: 0,
//       });

//       window.alert(
//         `Charge Successful: Charged ${CURRENCY}${cartTotal.toFixed(
//           2
//         )} to ${name}.`
//       );
